...
function getStagedFiles(path) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { stdout: staged } = yield spawnProcess('git', ['ls-files', '--recurse-submodules', '-s', '-z', '--exclude-standard', '.'], path);
        const res = new Map();
...
function getUnstagedFiles(path) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { stdout: unstagedInSubModules } = yield spawnProcess('git', [
            'submodule',
            'foreach',
            '--recursive',
            '--quiet',
...
function getUntrackedFiles(path) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { stdout: untrackedInSubModules } = yield spawnProcess('git', [
            'submodule',
            'foreach',
            '--recursive',
            '--quiet',
